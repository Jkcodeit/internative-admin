  ...
  const getAllGames = async (page) => {
    ...
    if (!isLoading) {
      ...
      var response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL_API}game/upcoming?page=${page}&limit=10`,
        {
          method: "GET",
          headers: {
              ...
              <Grid item xs={12} sm={6} md={4} key={game["id"]}>
                ...
                >
                  <GameCard
                    ...
                    openStaus={moment(game["openBiddingTime"]).fromNow()}
                    openDate={moment(game["openBiddingTime"]).format("ll")}
                  />
                </div>
              </Grid>
            ))}
